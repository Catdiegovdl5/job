...
def generate_proposal_ai(job_description, platform, api_key=None, model=DEFAULT_MODEL, temperature=DEFAULT_TEMP):
    """
    ...
    A proposta deve ser persuasiva, profissional e direta. Evite clichês.
...
if __name__ == "__main__":
    ...
    print(generate_proposal_ai(desc, "Freelancer.com"))
